...
const events = [
  ...
  { year:'2024', title:'Y-Link',           role:'Founder — NH-Solutions',
    desc:'Founded and built Y-Link — an AI-driven DMX lighting ecosystem for the AV and entertainment market. Targets venues with autonomous light show generation.',
